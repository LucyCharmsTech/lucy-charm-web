...
export default function AdminListingDetailPage({ params }: Props) {
  ...
  const img = listing.primary_image_url || 'https://picsum.photos/seed/admin-detail/900/600';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        >
          <h2 id="admin-insights-heading" className="text-lg font-bold text-zinc-900 dark:text-zinc-50">
            Client activity
          </h2>
