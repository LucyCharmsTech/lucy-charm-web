      ...
      >
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          <button
            ...
            disabled={busy}
            className={cn(
              'rounded-xl px-4 py-2 text-sm font-semibold text-primarycolor-foreground transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 dark:focus-visible:ring-offset-zinc-900',
              tone === 'danger'
