    ...
    >
      <div className="flex items-center justify-between border-b border-zinc-100 px-5 py-3.5 dark:border-zinc-800/80">
        <div className="flex items-center gap-2.5">
          <span className="inline-flex size-9 items-center justify-center rounded-xl bg-primarycolor/10 text-sm font-extrabold text-primarycolor-text">
            L
          </span>
          <div>
        ...
        <button
          type="button"
          onClick={onClose}
          className="rounded-lg p-1.5 text-zinc-500 dark:text-zinc-400 transition hover:bg-zinc-100 hover:text-zinc-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primarycolor focus-visible:ring-offset-2 dark:hover:bg-zinc-800 dark:hover:text-zinc-200"
          aria-label="Close"
        >
      ...
      <div className="flex flex-col items-center gap-4 px-5 pb-6 pt-5 text-center">
        <div className="flex size-14 items-center justify-center rounded-2xl bg-primarycolor/10 shadow-sm ring-1 ring-primarycolor/15">
          <BotIcon className="size-7 text-primarycolor-text" aria-hidden="true" />
        </div>
        <div>
        ...
        <div className="flex w-full flex-col gap-2">
          <Button
            asChild
            className="h-11 w-full rounded-xl bg-primarycolor font-semibold text-primarycolor-foreground shadow-sm hover:bg-primarycolor/90 focus-visible:ring-primarycolor"
          >
